...
4. At first launch, confirm the detected AI-client setup prompt. Alternatively, use **Configure AI clients** and choose all detected clients, Codex, Claude Desktop, or Cursor. Restart the configured AI client once.
5. The dashboard checks MCP, ZOS-API/OpticStudio, and recent AI-client activity automatically every 10 seconds. **Refresh now** is available when you want an immediate check.
